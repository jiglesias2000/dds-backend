...
const db = require('./aa-sqlite');
 ...
 async function CrearBase() {
    ...
    // verificar si existe la base, sino crearla
    const fs = require('fs');
    if (!fs.existsSync('./.data/pymes.db'))
    {
      console.log('no existe la base!')
      const sqlite3 = require('sqlite3').verbose()
      let db = new sqlite3.Database('./.data/pymes.db', (err) => {
          if (err) {
  ...
  await db.open('./.data/pymes.db')  // abrir
  ...
  if (!existe) {
    res = await db
      .run(
        `CREATE table articulos( IdArticulo INTEGER PRIMARY KEY AUTOINCREMENT
    ...
    res = await db
      .run(
        `insert into articulos values
          ...
          (155,'Aire acondicionado surreypria 3000fc 553epq1213f',7949,'0779708708631',7,180,'2017-01-04T00:00:00',1),(156,'Aire acondicionado surreypria 4500fc 553epq1813f',11849,'0779708708632',7,232,'2017-01-07T00:00:00',1),(157,'Aire acondicionado surreypria 5500fc 553epq2213f',14329,'0779708708633',7,909,'2017-01-10T00:00:00',1),(110,'Antena tp-link tl-ant2408c',249,'0693536405216',9,689,'2016-12-26T00:00:00',1),(164,'Calefactor electrico clever vidrio h1107',1950,'0779815957117',7,459,'2016-12-29T00:00:00',1),(165,'Calefactor electrico conveccion con-1800',1599,'0779814958212',7,10,'2017-01-13T00:00:00',1),(166,'Calefactor electrico conveccion con-2000n',790,'0779815957180',7,112,'2017-01-11T00:00:00',1),(167,'Calefactor electrico conveccion con-2000r',790,'0779815957181',7,141,'2017-01-26T00:00:00',1),(168,'Calefactor liliana infrarrojo ci062',345,'0779386200687',7,516,'2016-12-27T00:00:00',1),(169,'Calefactor panel 500 watts',769,'0779813482002',7,804,'2017-01-03T00:00:00',1),(158,'Calefactor sin salida 4000 kcal volcan',1159,'0779703781219',7,598,'2016-12-23T00:00:00',1),(159,'Calefactor sin salida orbis 4200 kcal',1469,'0779703781123',7,504,'2017-01-11T00:00:00',0),(170,'Caloventor 2000 w axel ax-ca100',249,'0779811896139',7,780,'2017-01-10T00:00:00',1);
          `
      )
      .catch((err) => null);
  }
